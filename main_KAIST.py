...
parser.add_argument('--tv_weight', default=30, help="TV denoising weight (larger for smoother but slower)")
parser.add_argument('--tv_iter_max', default=40, help="TV denoising maximum number of iterations each")
